...
const FilterPanel = ({
  ...
  return (
    <div className="w-64 p-4 bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-3" data-testid="filter-header-moc">Consultation Type</h3>
      ...
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-3" data-testid="filter-header-speciality">Specialties</h3>
      ...
      <div>
        ...
        >
          <option value="fees" data-testid="sort-fees">Fees (Low to High)</option>
          <option value="experience" data-testid="sort-experience">Experience (High to Low)</option>
        </select>
      </div>
    </div>
  );
